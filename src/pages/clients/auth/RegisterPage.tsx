    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-stone-600">Join our community of coffee lovers</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-stone-700">
                I agree to the{" "}
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-amber-800 focus:ring-amber-800 border-stone-300 rounded"
              />
              <label htmlFor="subscribeNewsletter" className="ml-2 block text-sm text-stone-700">
          ...
          <div className="text-center">
            ...
            <Link to="/auth/login" className="text-amber-800 hover:text-amber-900 font-medium">
              Sign in
            </Link>
          </div>
        </form>
